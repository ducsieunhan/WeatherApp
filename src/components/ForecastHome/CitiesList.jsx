...
const CitiesList = ({ countryName, cityListName }) => {
  ...
  return (
    <div className="max-w-screen-xl mx-auto border border-slate-300 md:text-[18px] text-[15px] my-4 rounded-md">
      <h3 className="bg-slate-300/15 p-3 border-b border-slate-300 text-[18px]">Cities weather forecast in {countryName}</h3>
      <div className="grid grid-cols-2 md:grid-cols-3 justify-start py-4 px-10 gap-3">
        {
