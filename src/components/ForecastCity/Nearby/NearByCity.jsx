...
const NearByCity = ({ name, tempMin, tempMax, description, condition, label }) => {
  ...
  return (
    <Link to={`/city?city=${name}&label=${label}`} className="flex justify-between p-1 border-b border-dashed border-slate-500 cursor-pointer hover:bg-slate-600 transition">
